...
- **[SkillDB](https://github.com/latentsmurf/SkillDB)** - Agent skill library with 5,600+ specialist skills across 37 domains. 10 MCP tools for autonomous discovery and loading of expert-level instructions (security audits, code review, React performance, etc.). Install: `npx skilldb-mcp`. Works with Claude Code, Cursor, Windsurf.
